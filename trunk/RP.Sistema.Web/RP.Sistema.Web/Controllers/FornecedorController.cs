...
{ 
    public class FornecedorController : Controller
    {
        ...
        {
            LogBLL.Insert(new LogDado("Index", "Fornecedor", _idUsuario));
            return View();
        }
        ...
        {
            LogBLL.Insert(new LogDado("Details", "Fornecedor", _idUsuario));
        ...
        public ActionResult Edit(FornecedorVM model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    LogBLL.Insert(new LogDado("Edit", "Fornecedor", _idUsuario));
                    using (var db = new Context())
                    {
                        using (var trans = new RP.DataAccess.RPTransactionScope(db))
                        {
        ...
        public ActionResult Report(string filter)
        {
            try
            {
                LogBLL.Insert(new LogDado("Report", "Fornecedor", _idUsuario));
                using (var db = new Context())
                {
